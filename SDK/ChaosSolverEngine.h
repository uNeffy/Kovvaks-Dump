...
{ 
	...
	SDK_UNDEFINED(80,810) /* TSet<UObject*> */         __um(ChaosHandlers);                                        // 0x0008   (0x0050)  
};
...
public:
	...
	// FHitResult ConvertPhysicsCollisionToHitResult(FChaosPhysicsCollisionInfo& PhysicsCollision);                             // [0x3597aa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetSolverActive(bool bActive);                                                                                      // [0x3597bc0] Native|Public|BlueprintCallable 
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver
	// void SetAsCurrentWorldSolver();                                                                                          // [0x3597ba0] Final|Native|Public|BlueprintCallable 
};
