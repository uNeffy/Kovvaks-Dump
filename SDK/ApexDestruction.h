...
public:
	...
	SDK_UNDEFINED(16,762) /* FMulticastInlineDelegate */ __um(OnActorFracture);                                    // 0x0228   (0x0010)  
};

/// Class /Script/ApexDestruction.DestructibleComponent
/// Size: 0x0770 (1904 bytes) (0x000690 - 0x000770) align 16 MaxSize: 0x0770
class UDestructibleComponent : public USkinnedMeshComponent
{ 
public:
	bool                                               bFractureEffectOverride : 1;                                // 0x0690:0 (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x0691   (0x0007)  MISSED
	TArray<FFractureEffect>                            FractureEffects;                                            // 0x0698   (0x0010)  
	bool                                               bEnableHardSleeping;                                        // 0x06A8   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x06A9   (0x0003)  MISSED
	float                                              LargeChunkThreshold;                                        // 0x06AC   (0x0004)  
	unsigned char                                      UnknownData02_6[0x10];                                      // 0x06B0   (0x0010)  MISSED
	SDK_UNDEFINED(16,763) /* FMulticastInlineDelegate */ __um(OnComponentFracture);                                // 0x06C0   (0x0010)  
	unsigned char                                      UnknownData03_7[0xA0];                                      // 0x06D0   (0x00A0)  MISSED


	/// Functions
	// Function /Script/ApexDestruction.DestructibleComponent.SetDestructibleMesh
	// void SetDestructibleMesh(class UDestructibleMesh* NewMesh);                                                              // [0x812700] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.GetDestructibleMesh
	// class UDestructibleMesh* GetDestructibleMesh();                                                                          // [0x8126d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyRadiusDamage
	// void ApplyRadiusDamage(float BaseDamage, FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage); // [0x812510] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyDamage
	// void ApplyDamage(float DamageAmount, FVector& HitLocation, FVector& ImpulseDir, float ImpulseStrength);                  // [0x812390] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
static_assert(sizeof(UDestructibleComponent) == 0x0770); // 1904 bytes (0x000690 - 0x000770)
...
static_assert(offsetof(UDestructibleComponent, FractureEffects) == 0x0698);
