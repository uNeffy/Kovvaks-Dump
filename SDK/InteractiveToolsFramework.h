...
public:
	...
	SDK_UNDEFINED(16,880) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,881) /* TScriptInterface<Class> */ __um(AngleSource);                                         // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,882) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,883) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,884) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,885) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,886) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,887) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	...
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x355fd70] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x355fce0] Final|Native|Public  
};
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x355fb70] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x355f9c0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x355fa30] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x355f8d0] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x355f820] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x355f7e0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x355fc50] Native|Public|Const  
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x355f780] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x355f7a0] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x355fae0] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x355f890] Native|Public|HasDefaults|Const 
...
{ 
public:
	SDK_UNDEFINED(16,888) /* TScriptInterface<Class> */ __um(FloatParameterSource);                                // 0x0048   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,889) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,890) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,891) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,892) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,893) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,894) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,895) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,896) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,897) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,898) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,899) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,900) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,901) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,902) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,903) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,904) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
	bool                                               bEnableSignedAxis;                                          // 0x0088   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,905) /* TScriptInterface<Class> */ __um(TransactionManager);                                  // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,906) /* TScriptInterface<Class> */ __um(ChildTransformSource);                                // 0x0048   (0x0010)  
