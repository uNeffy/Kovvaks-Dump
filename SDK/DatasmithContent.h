...
{ 
public:
	SDK_UNDEFINED(80,849) /* TSet<FName> */            __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,850) /* TSet<FName> */            __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
public:
	...
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key);                                               // [0xf31080] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0xf30ec0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                              // [0xf30e30] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                            // [0xf31190] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(80,851) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);               // 0x00F8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,852) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                          // 0x0228   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,853) /* TSet<FName> */            __um(Tags);                                                 // 0x0098   (0x0050)  
